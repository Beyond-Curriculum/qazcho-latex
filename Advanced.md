...
3. [Файл с задачами](#файл-с-задачами)
    1. [Основной файл](#основной-файл)
        1. [Преамбула](#преамбула-1)
        1. [Титульный лист](#титульный-лист-1)
...
4. [Файл с решениями](#файл-с-решениями)
    1. [Основной файл](#основной-файл-1)
        1. [Преамбула](#преамбула-2)
        1. [Титульный лист](#титульный-лист-2)
        1. [Регламент, периодическая таблица, задачи](#регламент-периодическая-таблица-задачи-1)
    1. [Файл с самим решением](#файл-с-самим-решением)
        1. [Название задачи](#название-задачи-1)
        1. [Таблица с баллами](#таблица-с-баллами-1)
        1. [Боксы с решением](#боксы-с-решением)
            1. [Обычные задачи](#обычные-задачи-1)
            1. [Задачи по органике](#задачи-по-органике-1)
