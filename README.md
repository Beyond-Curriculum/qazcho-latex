...
Ниже --- гайд по тому, как писать код для бланка, файла с задачами и файла с решениями. Из важного --- компилировать надо не с помощью pdfLaTex, а XeLaTeX. Если компилируем в Overleaf, надо открыть проект, открыть меню и в поле "Compiler" выбрать "XeLaTeX".
...
В папке "templates" можно найти архивы с темплейтами для бланка, файла задач и файла решений. Чтобы начать писать задачу или решение к ней, достаточно скачать нужный архив, зайти на [overleaf.com](https://overleaf.com), нажать "create project", выбрать "upload project" и в появившемся окне выбрать этот архив.
